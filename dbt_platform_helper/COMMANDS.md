...
- `--name
-n <text>` _Defaults to []._
  - The name of the service to generate a manifest for.
- `--environment
-e <text>` _Defaults to []._
  - The name of the environments to generate service manifests for.
- `--help <boolean>` _Defaults to False._
  - Show this message and exit.
