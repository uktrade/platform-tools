...
from dbt_platform_helper.constants import IMAGE_TAG_VAR
from dbt_platform_helper.constants import PLATFORM_HELPER_VERSION_OVERRIDE_KEY
from dbt_platform_helper.constants import (
    TERRAFORM_EXTENSIONS_MODULE_SOURCE_OVERRIDE_ENV_VAR,
)
from dbt_platform_helper.constants import TERRAFORM_MODULE_SOURCE_TYPE
...
class ServiceManger:
    ...
    def generate(self, environments: list[str], services: list[str]):
        ...
        source_type = self.environment_variable_provider.get(TERRAFORM_MODULE_SOURCE_TYPE)

        module_source_override_var = self.environment_variable_provider.get(
            TERRAFORM_EXTENSIONS_MODULE_SOURCE_OVERRIDE_ENV_VAR
        )
        image_tag = self.environment_variable_provider.get(IMAGE_TAG_VAR, IMAGE_TAG_DEFAULT)
        ...
        for service in service_models:
            ...
            for environment in environments:
                ...
                # TODO merge the environment specific overrides before writing
