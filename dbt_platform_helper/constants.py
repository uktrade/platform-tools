...
GIT_PLATFORM_TOOLS_REPO_SSH = "git@github.com:uktrade/platform-tools.git/"
ENVIRONMENT_PIPELINE_MODULE_PATH = (
    f"git::{GIT_PLATFORM_TOOLS_REPO_SSH}/terraform/environment-pipelines?depth=1&ref="
)

CODEBASE_PIPELINE_MODULE_PATH = (
    f"git::{GIT_PLATFORM_TOOLS_REPO_SSH}/terraform/codebase-pipelines?depth=1&ref="
)
EXTENSIONS_MODULE_PATH = f"git::{GIT_PLATFORM_TOOLS_REPO_SSH}/terraform/extensions?depth=1&ref="
