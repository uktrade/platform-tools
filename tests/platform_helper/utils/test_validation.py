    ...
    [
        ...
        (
            "datadog_addons_bad_data.yml",
            {
                ...
                "my-datadog-bad-contacts-name": r"'environments'.*'default'.*contacts.*name.*should be instance of 'str'",
                "my-datadog-bad-contacts-type": r"'environments'.*'default'.*contacts.*type.*should be instance of 'str'",
                "my-datadog-bad-contacts-contact": r"'environments'.*'default'.*contacts.*contact.*should be instance of 'str'",
