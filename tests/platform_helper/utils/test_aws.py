...
@patch("click.secho")
def test_get_aws_session_or_abort_with_invalid_credentials(mock_secho):
    ...
    with patch("boto3.session.Session") as mock_session:
        with patch("dbt_platform_helper.utils.aws.get_account_details") as mock_get_account_details:
...
@patch("click.secho")
def test_get_aws_session_or_abort_with_misconfigured_profile(mock_secho):
