...
class TestGenerate:
    ...
    def test_generate_terraform(
        ...
        ref = terraform_platform_modules_version if terraform_platform_modules_version else "5"
        assert (
            f"git::https://github.com/uktrade/terraform-platform-modules.git//extensions?depth=1&ref={ref}"
            in content
        )
