...
def test_https_certificate_for_application(mock_application):
    ...
    # TODO: DBTP-1977: mocking because isDeafult is lost when adding cert to listener https://github.com/getmoto/moto/blob/9e8bc74f3610ed390e7fad4bb90af574b68dd1f1/moto/elbv2/models.py#L2017 trufflehog:ignore
