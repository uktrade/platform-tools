...
def test_generate_codebase_pipeline_config_creates_file(
    ...
    aws_provider = json_content["provider"][0]["aws"]
    ...
    aws_provider_allowed_account_ids = json_content["provider"][1]["aws"]
    assert aws_provider_allowed_account_ids["allowed_account_ids"] == ["1122334455"]
