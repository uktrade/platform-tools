...
# @patch("dbt_platform_helper.jinja2_tags.version", new=Mock(return_value="v0.1-TEST"))
# def test_generate_terraform_environment_pipeline_manifest_as_part_of_pipeline_generate(fakefs):
#     setup_fixtures(
...
#     expected_files_dir = Path("terraform/environment-pipelines/platform-sandbox-test/main/main.tf")
