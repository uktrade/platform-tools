...
def test_service_exec(mock_application, mock_service_manager_object):
    """Test that given an app, env and service name strings, the service exec command
    calls exec with app, env and service name."""
    ...
    mock_service_manager_instance.service_exec.assert_called_with("test-application", "development", "test-service")
