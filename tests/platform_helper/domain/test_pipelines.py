...
def test_pipeline_generate_calls_generate_environment_pipeline_config_with_expected_platform_helper_version(
    fakefs,
    ...
    mock_t_m_p.generate_environment_pipeline_config.assert_called_once_with(
        platform_config_for_env_pipelines,
        expected_platform_helper_version,
