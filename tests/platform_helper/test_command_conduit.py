...
def test_add_stack_delete_policy_to_task_role(sleep, mock_stack, addon_name, mock_application):
    ...
    from dbt_platform_helper.commands.conduit import (
...
def test_update_conduit_stack_resources(
    ...
    from dbt_platform_helper.commands.conduit import update_conduit_stack_resources
...
def test_get_or_create_task_name(mock_application):
    ...
    from dbt_platform_helper.commands.conduit import get_or_create_task_name
...
def test_get_parameter_name(access, addon_type, addon_name, mock_application):
    ...
    from dbt_platform_helper.commands.conduit import get_parameter_name
...
@patch("subprocess.call")
@patch("dbt_platform_helper.commands.conduit.addon_client_is_running", return_value=True)
...
@patch("time.sleep", return_value=None)
@patch("subprocess.call")
@patch("dbt_platform_helper.commands.conduit.addon_client_is_running", return_value=False)
...
@patch("dbt_platform_helper.commands.conduit.get_cluster_arn", return_value="test-arn")
@patch("dbt_platform_helper.commands.conduit.get_parameter_name")
@patch("dbt_platform_helper.commands.conduit.get_or_create_task_name")
@patch("dbt_platform_helper.commands.conduit.addon_client_is_running", return_value=False)
@patch("dbt_platform_helper.commands.conduit.create_addon_client_task")
@patch("dbt_platform_helper.commands.conduit.connect_to_addon_client_task")
...
def test_start_conduit(
    ...
    from dbt_platform_helper.commands.conduit import start_conduit
...
@patch("dbt_platform_helper.commands.conduit.get_cluster_arn")
@patch("dbt_platform_helper.commands.conduit.get_parameter_name")
@patch("dbt_platform_helper.commands.conduit.get_or_create_task_name")
@patch("dbt_platform_helper.commands.conduit.addon_client_is_running", return_value=False)
@patch("dbt_platform_helper.commands.conduit.create_addon_client_task")
...
def test_get_addon_type(addon_name, expected_type, mock_application):
    ...
    from dbt_platform_helper.commands.conduit import get_addon_type
...
def test_get_addon_type_when_addon_not_found(mock_application):
    ...
    from dbt_platform_helper.commands.conduit import AddonNotFoundConduitError
    from dbt_platform_helper.commands.conduit import get_addon_type
...
def test_get_addon_type_when_parameter_not_found(mock_application):
    ...
    from dbt_platform_helper.commands.conduit import ParameterNotFoundConduitError
    from dbt_platform_helper.commands.conduit import get_addon_type
