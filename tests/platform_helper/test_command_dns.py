...
from dbt_platform_helper.commands.dns import cdn_delete
from dbt_platform_helper.commands.dns import cdn_list
from dbt_platform_helper.commands.dns import configure
from dbt_platform_helper.commands.dns import copy_records_from_parent_to_subdomain
from dbt_platform_helper.commands.dns import create_cert
from dbt_platform_helper.commands.dns import create_hosted_zones
from dbt_platform_helper.commands.dns import create_required_zones_and_certs
from dbt_platform_helper.commands.dns import get_base_domain
from dbt_platform_helper.commands.dns import get_certificate_zone_id
from dbt_platform_helper.commands.dns import get_required_subdomains
from dbt_platform_helper.commands.dns import validate_subdomains
...
def test_copy_records_from_parent_to_subdomain(
    ...
    with patch("dbt_platform_helper.commands.dns.add_records") as mock_add_records:
...
@patch(
    "dbt_platform_helper.commands.dns._wait_for_certificate_validation",
...
@patch("click.confirm")
@patch(
    "dbt_platform_helper.commands.dns._get_hosted_zones_paginator",
    return_value=[
        {"HostedZones": [{"Name": "web.domain", "Id": 1}]},
        {
            "HostedZones": [
                {"Name": "uktrade.digital", "Id": 2},
                {"Name": "dev.uktrade.digital", "Id": 3},
            ]
        },
    ],
)
...
@patch(
    ...
    return_value=[
        ...
        {
            "HostedZones": [
                {"Name": "uktrade.domain", "Id": 2},
                {"Name": "dev.domain.digital", "Id": 3},
            ]
        },
    ],
)
...
@patch(
    "dbt_platform_helper.commands.dns.create_cert",
    return_value="arn:1234",
)
@patch("click.confirm")
def test_create_required_zones_and_certs(
    ...
    with patch("dbt_platform_helper.commands.dns.create_hosted_zones") as mock_create_hosted_zones:
...
@patch("dbt_platform_helper.commands.dns.get_aws_session_or_abort")
@patch(
    "dbt_platform_helper.commands.dns.create_required_zones_and_certs",
    return_value="arn:1234",
)
...
def test_configure_gets_the_correct_domain_profile(
    ...
    with patch("dbt_platform_helper.commands.dns.get_aws_session_or_abort") as mock_get_session:
        runner = CliRunner()
        result = runner.invoke(
            configure,
            [
