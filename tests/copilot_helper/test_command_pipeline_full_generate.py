...
from dbt_copilot_helper.commands.pipeline import full_generate
...
def test_pipeline_full_generate_with_git_repo_creates_the_pipeline_configuration(
    ...
    result = CliRunner().invoke(full_generate)
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_with_only_environments_creates_the_pipeline_configuration(
    git_remote, get_aws_session_or_abort, fakefs
):
    mock_codestar_connections_boto_client(get_aws_session_or_abort, ["test-app"])
    setup_fixtures(fakefs)
    ...
    CliRunner().invoke(full_generate)
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_with_only_codebases_creates_the_pipeline_configuration(
    git_remote, get_aws_session_or_abort, fakefs
):
    mock_codestar_connections_boto_client(get_aws_session_or_abort, ["test-app"])
    setup_fixtures(fakefs)
...
@patch("boto3.client")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_with_empty_pipelines_yml_does_nothing(
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_overwrites_any_existing_config_files(
    git_remote, get_aws_session_or_abort, fakefs
):
    mock_codestar_connections_boto_client(get_aws_session_or_abort, ["test-app"])
    setup_fixtures(fakefs)
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_with_no_bootstrap_yml_succeeds(
    git_remote, get_aws_session_or_abort, fakefs
):
    setup_fixtures(fakefs)
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_with_no_codestar_connection_exits_with_message(
    git_remote, get_aws_session_or_abort, fakefs
):
...
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value=None)
def test_pipeline_full_generate_with_no_repo_fails_with_message(git_remote, fakefs):
    setup_fixtures(fakefs)
    result = CliRunner().invoke(full_generate)
...
def test_pipeline_full_generate_with_no_pipeline_yml_fails_with_message(fakefs):
    setup_fixtures(fakefs)
...
def test_pipeline_full_generate_pipeline_yml_invalid_fails_with_message(fakefs):
    setup_fixtures(fakefs)
...
def test_pipeline_full_generate_pipeline_yml_defining_the_same_env_twice_fails_with_message(fakefs):
    setup_fixtures(fakefs)
    pipelines = yaml.safe_load(Path("pipelines.yml").read_text())
...
def test_pipeline_full_generate_with_no_bootstrap_yml_or_workspace_fails_with_message(fakefs):
    setup_fixtures(fakefs)
    os.remove("bootstrap.yml")
...
def test_pipeline_full_generate_with_invalid_bootstrap_yml_and_no_workspace_fails_with_message(
    fakefs,
):
    setup_fixtures(fakefs)
...
@patch("dbt_copilot_helper.utils.aws.get_aws_session_or_abort")
@patch("dbt_copilot_helper.commands.pipeline.git_remote", return_value="uktrade/test-app-deploy")
def test_pipeline_full_generate_without_accounts_creates_the_pipeline_configuration(
