...
from dbt_copilot_helper.custom_resources.app_user import create_db_user
from dbt_copilot_helper.custom_resources.app_user import create_or_update_user_secret
from dbt_copilot_helper.custom_resources.app_user import drop_user
from dbt_copilot_helper.custom_resources.app_user import handler
from dbt_copilot_helper.custom_resources.app_user import send
...
class TestAppUserCustomResource(unittest.TestCase):
    ...
    @patch("dbt_copilot_helper.custom_resources.app_user.create_db_user")
    @patch("dbt_copilot_helper.custom_resources.app_user.send")
    @patch("dbt_copilot_helper.custom_resources.app_user.psycopg2.connect")
    @mock_secretsmanager
    @mock_ssm
    ...
    @patch("dbt_copilot_helper.custom_resources.app_user.drop_user")
    @patch("dbt_copilot_helper.custom_resources.app_user.send")
    @patch("dbt_copilot_helper.custom_resources.app_user.psycopg2.connect")
    @mock_secretsmanager
    @mock_ssm
    ...
    @patch("dbt_copilot_helper.custom_resources.app_user.create_db_user", side_effect=Exception())
    @patch("dbt_copilot_helper.custom_resources.app_user.send")
    @patch("dbt_copilot_helper.custom_resources.app_user.psycopg2.connect")
    @mock_secretsmanager
