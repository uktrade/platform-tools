...
#     result = get_query_results("test", "testapp", "foo", "query_string")
#     breakpoint()
#     assert ("Timeout threshold breached, no results returned." in result.output)
...
@mock_sts
@patch(
    "dbt_copilot_helper.commands.application.get_query_results",
