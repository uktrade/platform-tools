    ...
    [
        ...
        (
            "rds_addons_bad_data.yml",
            {
                ...
                "my-rds-db-5a": r"environments'.*'default'.*'volume-size'.*should be an integer between 5 and 10000",
                "my-rds-db-5b": r"environments'.*'default'.*'volume-size'.*should be an integer between 5 and 10000",
                "my-rds-db-5c": r"environments'.*'default'.*'volume-size'.*should be an integer between 5 and 10000",
                "my-rds-db-6": r"'environments'.*'default'.*snapshot-id.*False should be instance of 'str'",
                "my-rds-db-7": r"'environments'.*'default'.*deletion-policy.*'Snapshot' does not match 'None'",
                "my-rds-db-8": r"'environments'.*'default'.*deletion-protection.*12 should be instance of 'bool'",
            },
        ),
        (
            "redis_addons_bad_data.yml",
            {
                ...
                "my-redis-6": r"environments.*default.*deletion-policy.*does not match 'Never'",
            },
        ),
        (
            "opensearch_addons_bad_data.yml",
            {
                ...
                "my-opensearch-7": r"environments.*dev.*volume_size.*should be an integer between 10 and 511",
                "my-opensearch-8": r"environments.*dev.*volume_size.*should be an integer between 10 and 511",
                "my-opensearch-9": r"environments.*dev.*deletion-policy.*does not match 'Snapshot'",
            },
        ),
        (
