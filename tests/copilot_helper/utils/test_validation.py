    ...
    [
        (
            "s3_addons_bad_data.yml",
            {
                ...
                "my-s3-bucket-14": r"retention_policy.*did not validate 'bad-policy'.*should be instance of 'dict'",
                "my-s3-bucket-15": r"retention_mode.*GOVERNANCE.*does not match 'BAD_MODE'",
                "my-s3-bucket-16": r"retention_policy.*There are multiple keys present from the .*'retention_days'.*'retention_years'.* condition",
                "my-s3-bucket-17": r"retention_days.*should be instance of 'int'",
                "my-s3-bucket-18": r"retention_years.*should be instance of 'int'",
            },
        ),
        (
