    ...
    [
        ...
        (
            "rds_addons_bad_data.yml",
            {
                ...
                "my-rds-db-volume-too-small": r"environments'.*'default'.*'volume_size'.*should be an integer between 5 and 10000",
                "my-rds-db-volume-too-big": r"environments'.*'default'.*'volume_size'.*should be an integer between 5 and 10000",
                "my-rds-db-volume-not-an-int": r"environments'.*'default'.*'volume_size'.*should be an integer between 5 and 10000",
