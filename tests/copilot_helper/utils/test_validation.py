    ...
    [
        (
            "s3_addons_bad_data.yml",
            {
                ...
                "my-s3-bucket-15": r"mode.*GOVERNANCE.*does not match 'BAD_MODE'",
                "my-s3-bucket-16": r"retention_policy.*There are multiple keys present from the .*'days'.*'years'.* condition",
                "my-s3-bucket-17": r"days.*should be instance of 'int'",
                "my-s3-bucket-18": r"years.*should be instance of 'int'",
            },
        ),
        (
