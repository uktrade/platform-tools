...
To do so, select "Start build with overrides", navigate to "Additional configuration" in the "Environment" section, and set `TARGET_ENVIRONMENT` env variable value to your environment name.
