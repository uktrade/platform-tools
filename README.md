...
4. Get API token from [Passman](https://passman.ci.uktrade.digital/secret/cc82a3f7-ddfa-4312-ab56-1ff8528dadc8/). (Note that you will need access to the platform group in Passman first)
