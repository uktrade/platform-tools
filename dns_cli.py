...
def check_aws_conn(aws_profile):
    ...
    try:
        ...
        print("The SSO session associated with this profile has expired or is otherwise invalid.",
    ...
    print(f"Logged in with AWS Domain account: {account_name[0]}/{sts.get_caller_identity()['Account']}\n\
