locals {
  ...
  non_copilot_service_deployment_mode = var.service_deployment_mode == "dual-copilot-traffic" || var.service_deployment_mode == "dual-platform-traffic" || var.service_deployment_mode == "platform" ? 1 : 0
}
