locals {
  ...
  non_copilot_service_deployment_mode = var.service-deployment-mode == "dual-copilot-traffic" || var.service-deployment-mode == "dual-platform-traffic" || var.service-deployment-mode == "platform" ? 1 : 0
}
